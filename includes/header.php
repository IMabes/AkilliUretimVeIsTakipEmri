    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navMain">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <?php if ($isCustomer): ?>
                    <li class="nav-item"><a class="nav-link" href="portal_siparisler.php">Siparişlerim</a></li>
                <?php else: ?>
                    <li class="nav-item"><a class="nav-link" href="dashboard.php">Dashboard</a></li>
                    <?php if ($canCustomers): ?>
                        <li class="nav-item"><a class="nav-link" href="customers.php">Müşteriler</a></li>
                        <li class="nav-item"><a class="nav-link" href="orders.php">Siparişler</a></li>
                    <?php endif; ?>
                    <li class="nav-item"><a class="nav-link" href="work_orders.php">İş Emirleri</a></li>
                    <li class="nav-item"><a class="nav-link" href="production.php">Üretim Takibi</a></li>
                    <?php if ($canReports): ?>
                        <li class="nav-item"><a class="nav-link" href="reports.php">Raporlar</a></li>
                    <?php endif; ?>
                    <?php if ($canUsers): ?>
                        <li class="nav-item"><a class="nav-link" href="users.php">Personel</a></li>
                    <?php endif; ?>
                <?php endif; ?>
            </ul>
                            ...
                            <?php foreach ($notifs as $n): ?>
                                <li>
                                    <a class="dropdown-item small<?= (int) $n['okundu'] ? ' text-muted' : '' ?>"
                                       href="notification_read.php?id=<?= (int) $n['id'] ?>">
                                        <?= e($n['mesaj']) ?>
                                    </a>
                                </li>
                            <?php endforeach; ?>
